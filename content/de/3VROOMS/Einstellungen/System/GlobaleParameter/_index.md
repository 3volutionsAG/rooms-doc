...
| 85 | Portal Block Times Color | The color for block times to be used in Portal Integration calendar. | 806245 |
...
| 64 | System User Id | The ID of the anonymous system user used for unauthenticated or automated operations, such as bookings, check-ins/outs, and other system-driven tasks. |  |
